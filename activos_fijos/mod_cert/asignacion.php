...
if ($_SESSION["usuario_nombre"]) {
    ...
    <center>
        ...
        <table>
            <tr>
                <td class="titulo">Personal para Asignación de Activos</td>
            </tr>
        </table><br>
        ...
        <table id="resultado" class="display" width="90%" height="55" style="border:1px;" align="center">
            ...
            <tbody>
                ...
                $consulta = "SELECT d.id_departamento, d.codigo_departamento, d.nom_departamento, a.codigo_area, a.nom_area, p.id_personal, 
                                p.ubicacion, p.ci, p.nombres,  p.apaterno,  p.amaterno, c.descripcion,
                                p.id_cargo, p.direccion, p.telefonos, p.estado
                                FROM dbo.personal p, dbo.departamentos d, dbo.area a, dbo.cargo c
                                WHERE p.estado=1 and d.id_departamento=a.id_departamento and a.id_area=p.id_area and p.id_cargo=c.id_cargo
                                order by a.id_area";
                ...
                if (count($resultado) > 0) {
                    ...
                    foreach ($resultado as $fila) {
                        ...
                        <tr bgcolor="#F2F9FF">
                            ...
                            <th align="center" class="colDat">
                                <!-- <?php echo "<a href='asigna.php?id_personal=" . $fila["id_personal"] . "'title='asignar'>ASIGNA</a>"; ?> -->
                                <?php echo "<a href='attached.php?op=9&id=" . $fila["id_personal"] . "'title='asignar'>ASIGNA</a>"; ?>
                            </th>
                        </tr>
                        <?php
                    }
