    ...
    <center>
        ...
        <table id="resultado" class="display" width="90%" height="55" style="border:1px;" align="center">
            ...
            <tbody>
                ...
                $consulta = "SELECT d.id_departamento, d.codigo_departamento, d.nom_departamento, a.codigo_area, a.nom_area, p.id_personal, p.ubicacion, p.ci, p.nombres,  p.apaterno,  p.amaterno, c.descripcion, p.direccion, p.telefonos, p.estado 
                FROM personal p, departamentos d, area a, cargo c
                WHERE p.estado=1 and d.id_departamento=a.id_departamento and a.id_area=p.id_area and c.id_cargo=p.id_cargo and p.id_personal!=$id_transferente
                order by a.id_area";
                ...
                if (count($resultado) > 0) {
                    foreach ($resultado as $fila) {
                        ...
                        <tr bgcolor="#F2F9FF">
                            ...
                            <th align="center" class="colDat">
                                <?php echo "<a href='transferencia.php?id_personal=" . $fila["id_personal"] . "&id_personal2=" . $id_transferente . "'title='asignar'>TRANSFERIR</a>"; ?>
                            </th>
                        </tr>
                        <?php
                    }
