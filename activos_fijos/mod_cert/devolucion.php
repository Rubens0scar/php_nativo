...
if ($_SESSION["usuario_nombre"]) {
    ...
    <center>
        ...
        <table>
            <tr>
                <td class="titulo">Personal para Devolución de Activos</td>
            </tr>
        </table><br>
                ...
                if (count($resultado) > 0) {
                    foreach ($resultado as $fila) {
                        ...
                        <tr bgcolor="#F2F9FF">
                            ...
                            <th align="center" class="colDat">
                                <!-- <?php echo "<a href='devuelve.php?id_personal=" . $fila["id_personal"] . "'title='devolucion'>DEVOLUCION</a>"; ?> -->
                                <?php echo "<a href='attached.php?op=10&id=" . $fila["id_personal"] . "'title='devolucion'>DEVOLUCION</a>"; ?>
                            </th>
                        </tr>
                        <?php
                    }
