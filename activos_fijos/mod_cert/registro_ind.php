                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td><input type="text" id="id_registro_activos" name="id_registro_activos"
                                                        value="<?php echo $_REQUEST["id_registro_activos"]; ?>"
                                            ...
                                            <tr>
                                                <td>Paginación:</td>
                                                <?php
                                                $id_regact = $_REQUEST["id_registro_activos"];
                                            ...
                                            <tr>
                                                <td>Activo:</td>
                                                <td><select id="id_activo" name="id_activo"
                        ...
                        if (count($resultado) > 0) {
                            foreach ($resultado as $fila) {
                                ...
                                <tr bgcolor="#F2F9FF">
                                    ...
                                    <td align="center" class="colDat">
                                        <?php
                                        echo "<a href='guardar.php?id_regind=" . $fila["id_registro_individual"] . "&id_regact=" . $fila["id_registro_activos"] . "&op=10'title='eliminar';>"
                                            ?>
